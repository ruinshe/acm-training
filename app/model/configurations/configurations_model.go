...
// arModel is a active record design model for table configurations operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of configurations.
	Table = "configurations"
	// Model is the model object of configurations.
